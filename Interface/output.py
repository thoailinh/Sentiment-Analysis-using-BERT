...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.TextInput.setGeometry(QtCore.QRect(110, 120, 440, 250))
        font = QtGui.QFont()
        ...
        self.TextInput.setOverwriteMode(False)
        self.TextInput.setObjectName("TextInput")
        self.analysis = QtWidgets.QPushButton(self.centralwidget)
        self.analysis.setGeometry(QtCore.QRect(590, 190, 85, 45))
        font = QtGui.QFont()
        ...
        # self.label_3.setStyleSheet("background-color: blue;border: 1px solid black;") 
        ...
        # self.label_6.setGeometry(QtCore.QRect(380, 330, 60, 60))
